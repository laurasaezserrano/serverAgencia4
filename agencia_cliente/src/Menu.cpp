...
void Menu::menuPrincipal() {
    while (true) {
        ...
        if (m_rolActual == "admin" || m_rolActual == "ADMIN") {
        ...
        switch (op) {
            ...
            case 4: if (m_rolActual == "admin" || m_rolActual == "ADMIN") menuPrincipalClientes(); break;
            case 5: if (m_rolActual == "admin" || m_rolActual == "ADMIN") menuInformes(); break;
            case 0: return;
...
void Menu::menuPaquetes() {
    while (true) {
        ...
        switch (op) {
            ...
            case 3: if (m_rolActual == "admin" || m_rolActual == "ADMIN") crearPaquete(); break;
            case 4: if (m_rolActual == "admin" || m_rolActual == "ADMIN") bajaPaquete();  break;
            default: std::cout << "Opcion no valida.\n"; pausar();
        }
    }
}
